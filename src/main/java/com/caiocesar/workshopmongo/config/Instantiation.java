...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagem mano!", LocalDate.parse("21/03/2018", form).atStartOfDay(ZoneId.of("GMT")).toInstant(), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite", LocalDate.parse("22/03/2018", form).atStartOfDay(ZoneId.of("GMT")).toInstant(), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", LocalDate.parse("23/03/2018", form).atStartOfDay(ZoneId.of("GMT")).toInstant(), new AuthorDTO(alex));
